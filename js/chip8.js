class Chip8 {
  ...
  init() {
    this.memory = new Array(4096).fill(0x00);
    this.register = new Array(16).fill(0x00);
    this.stack = new Array(16).fill(0x00);
    this.index = 0;
    this.display = new Array(64 * 32).fill(0x00);
      ...
      switch (opcode & 0xf000) {
        case 0x0000:
          switch (opcode & 0x00ff) {
            ...
            case 0x00ee:
              console.log(
                `return from subruntine to addr ${this.stack[this.sp]}\n\n`
              );
              break;
          }
          break;
